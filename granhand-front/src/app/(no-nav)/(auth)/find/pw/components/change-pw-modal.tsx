...
export default function ChangePwModal({ open, setOpen }: { open: boolean, setOpen: (value: boolean) => void }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogHeader>
                <DialogTitle className="flex justify-center items-center text-2xl">GRANHAND.</DialogTitle>
            ...
            <DialogFooter className="w-full">
                ...
                <DialogClose className="w-full">
                    <div className="border-t w-full text-center pt-3" onClick={onClickConfirm}>
                        확인
                    </div>
                </DialogClose>
