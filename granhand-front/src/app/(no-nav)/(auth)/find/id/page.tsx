...
import ForeignFindId from "./components/foreign-find-id";
import FindIdResult from "./components/result";
...
export default function FindIdPage() {
    ...
    return (
        ...
        <>
            <NationalityPage />
            {/* <ForeignFindId onNext={() => setStep(2)} /> */}
            {/* { step === 1 && <FindId onNext={() => setStep(2)} /> }
            { step === 2 && <ForeignFindId onNext={() => setStep(3)} /> }
            {step === 3 && <FindIdResult />} */}
        </>
