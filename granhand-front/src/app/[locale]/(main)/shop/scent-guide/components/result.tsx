...
export default function ScentGuideResult() {
    return (
        <main className="container mx-auto px-6 pt-8 text-[#6F6963]">
        <section className="text-center max-w-xl mx-auto mb-16">
            <h2 className="text-sm font-bold uppercase tracking-wide text-[#DBD7D0] mb-3">Your Choice</h2>
            <h1 className="text-lg text-[#6F6963] font-bold mb-6">SUSIE SALMON. 수지살몬</h1>
            ...
            <p className="text-xs text-[#C0BCB6] mb-8">
            <span className="font-bold">{"향조 노트"}</span>
            <br />
        ...
        <section>
            <h3 className="text-sm font-bold text-[#6F6963] mb-4">RECOMMENDED</h3>
