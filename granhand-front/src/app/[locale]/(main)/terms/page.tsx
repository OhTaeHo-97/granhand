    ...
    return (
        <section className="container mx-auto px-6">
            <section className="py-8">
                <h2 className={`text-xl font-semibold text-left mb-8 border-t pt-4`}>이용약관</h2>
            </section>

            <main className="container mx-auto max-w-5xl">
                <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 1장 총 칙</h1>
            ...
            <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 2장 회사의 서비스</h1>
                ...
                <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 3장 서비스 이용계약</h1>
                ...
                <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 4장 구매계약 및 대금 결제</h1>
                ...
                <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 5장 계약당사자의 의무</h1>
                ...
                <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 6장 부가서비스의 이용</h1>
                ...
                <div className="mb-24">
                    <h1 className="text-xl font-bold mb-6">제 7장 기타</h1>
