    ...
    return (
        <section className="container mx-auto px-6">
            <section className="py-8">
                <h2 className={`text-xl font-semibold text-left mb-8 border-t pt-4`}>개인정보처리방침</h2>
            </section>
            ...
            <main className="container max-w-6xl">
                ...
                <div className="mb-6 overflow-x-auto pl-0 ml-0">
                    <section className="mb-6 space-y-1.5">
                        ...
                        <ol className="list-none pl-5 text-sm text-gray-700 space-y-1.5">
                        ...
                        <ul className="list-disc pl-5 text-sm text-gray-700 space-y-2 mb-4">
                            ...
                            <ul className="pl-5 text-sm text-gray-700 space-y-2 mb-4 [list-style-type:'-']">
                        ...
                        <div className="overflow-x-auto mb-6 w-full">
                            <table className="w-full text-sm text-left border border-gray-300">
                                ...
                                <tr className="w-full">
                                    <th className="border border-gray-300 text-center">구분</th>
                                    <th className="border border-gray-300 text-center">수집 목적</th>
                                    <th className="border border-gray-300 text-center">수집 항목</th>
                                    <th className="border border-gray-300 text-center">보유 및 이용기간</th>
                                    <th className="border border-gray-300 text-center min-w-30">필수/선택</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td className="border border-gray-300 text-center">회원가입시<br />(회원서비스 운영)</td>
                                    <td className="border border-gray-300 text-center">회원 가입의사 확인, 회원제 서비스 이용에 따른 본인 식별 및 인증, 회원자격 유지 및 관리, 서비스 부정이용 방지</td>
                                    <td className="border border-gray-300 text-center">이름, 이메일 주소, 전화번호, 성별, 로그인 ID</td>
                                    <td className="border border-gray-300 text-center">회원 탈퇴 시까지<br />(불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조가 필요한 경우 해지시로부터 1년까지)</td>
                                    <td className="border border-gray-300 text-center">필수</td>
                                </tr>
                                <tr>
                                    <td className="border border-gray-300 text-center">서비스 이용시</td>
                                    <td className="border border-gray-300 text-center">주문, 구매 및 요금 결제 처리, 물품배송 또는 청구지 등 발송, 금융거래 본인 인증 및 금융서비스</td>
                                    <td className="border border-gray-300 text-center">이름, 전화번호, 배송지 주소, 주문내역, 결제 정보</td>
                                    <td className="border border-gray-300 text-center">전자상거래법상 보유 및 이용기간(5년)</td>
                                    <td className="border border-gray-300 text-center">필수</td>
                                </tr>
                                <tr>
                                    <td className="border border-gray-300 text-center">고객 상담시</td>
                                    <td className="border border-gray-300 text-center">상품에 관한 고객상담</td>
                                    <td className="border border-gray-300 text-center">이름, 전화번호(연락처), 상담 내용</td>
                                    <td className="border border-gray-300 text-center">전자상거래법상 보유 및 이용기간(3년)</td>
                                    <td className="border border-gray-300 text-center">필수</td>
                                </tr>
                                <tr>
                                    <td className="border border-gray-300 text-center">마케팅 및 광고 활용</td>
                                    <td className="border border-gray-300 text-center">이벤트 등 광고성 정보 전달</td>
                                    <td className="border border-gray-300 text-center">이름, 이메일</td>
                                    <td className="border border-gray-300 text-center">전자상거래법상 보유 및 이용기간<br />(회원 탈퇴 또는 동의 철회 시까지)</td>
                                    <td className="border border-gray-300 text-center">선택</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <section className="mb-6 space-y-1.5">
                        ...
                        <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1.5 mb-4">
                            <li>회사는 회원가입, 주문 처리, 고객 상담, 마케팅 및 광고, 서비스 품질 개선을 위해 아래와 같은 개인정보를 수집하고 있습니다.</li>
                            <ul className="pl-5 text-sm text-gray-700 space-y-1.5 mb-4 [list-style-type:'-']">
                                <li>회원가입시 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 휴대전화번호 , 이메일 , 14세미만 가입자의 경우 법정대리인의 정보</li>
                                <li>서비스 신청시 : 주소, 결제 정보</li>
                            </ul>
                            <li>서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그, 쿠키, 접속 IP, 결제 기록, 불량이용 기록이 생성되어 수집될 수 있습니다.</li>
                    ...
                    <section className="mb-6">
                        ...
                        <ol className="list-none text-sm text-gray-700 space-y-1.5">
                            ...
                            <ul className="list-disc text-sm pl-5 text-gray-700 space-y-1.5 mb-4">
                    ...
                    <section className="mb-6">
                        ...
                        <div className="overflow-x-auto mb-6 w-full">
                            <table className="w-full text-sm text-left border border-gray-300 min-h-20">
                                <thead className="bg-gray-100">
                                <tr className="w-full">
                                    <th className="border border-gray-300 text-center">제공받는 자</th>
                                    <th className="border border-gray-300 text-center">제공 목적</th>
                                    <th className="border border-gray-300 text-center">제공 항목</th>
                                    <th className="border border-gray-300 text-center">보유 및 이용기간</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td className="border border-gray-300 text-center">스티비</td>
                                    <td className="border border-gray-300 text-center">뉴스레터 발송</td>
                                    <td className="border border-gray-300 text-center">이름, 이메일</td>
                                    <td className="border border-gray-300 text-center">수신거부 시 또는 개인정보 제3자 제공 철회시까지</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
