        ...
        <main className="mt-10">
            <div className="mx-auto">
                <Image
                    ...
                    alt="NOLL 제품 이미지"
                    className="w-[1120px] h-[627px] mb-8"
                    width={1120}
                    height={627}
                />
                <div className="prose max-w-none">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <h1 className="text-2xl text-black font-medium mb-4">NOLL 눈에 대한 모든 것.</h1>
                        <div className="flex flex-wrap gap-4 mt-4 md:mt-0">
                        <Popover>
                            <PopoverTrigger asChild>
                                <Share2 className="text-[#5E5955] w-[18px] h-[19px] !p-0" size={20} />
                            ...
                            <PopoverContent side="bottom" align="center" className="!w-[390px] h-[150px] rounded border bg-[#FDFBF5] p-6 shadow-md">
                                <div className="flex justify-between mb-2">
                                    <div className="font-bold text-[#6F6963]">공유하기</div>
                                    {/* 닫는 버튼 (자동으로 Popover 닫힘) */}
                                    <PopoverClose asChild>
                                        <X size={20} className="text-[#6F6963]" />
                                    </PopoverClose>
                                </div>

                                <div className="border border-[#C0BCB6] rounded w-[342px] h-[46px] max-w-xl flex items-center px-5 py-2 mt-6">
                                    {/* URL */}
                                    <span className="flex-1 text-[#C0BCB6] text-sm select-all truncate">https://granhand.com/event/11832</span>
                                    {/* 복사 아이콘 */}
                                    <Button
                                        onClick={handleCopy}
                                        className="ml-4 p-1 text-[#5E5955] hover:text-black transition"
                                        aria-label="클립보드에 복사"
                                        type="button"
                                    >
                                        {/* 복사 완료 메시지 */}
                    ...
                    <div className="flex items-center space-x-2 text-sm font-medium text-[#C0BCB6] mb-8">
                    {/* <span>#Team</span>
                    <span>·</span> */}
                    ...
                    <div className="w-[736px] mb-28 text-sm">
                        <p className="text-[#322A24] leading-relaxed">
