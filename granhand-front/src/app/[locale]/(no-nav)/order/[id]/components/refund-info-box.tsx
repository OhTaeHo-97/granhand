    ...
    return (
        <div className="border rounded-md p-4 space-y-3 shadow-md">
            ...
            <div className="text-sm text-gray-400 ml-2 space-y-2">
                ...
                <div className="flex justify-between">
                    <span>{t('order:additional_ship_fee')}</span>
                    <span>0원</span>
                </div>
                <div className="flex justify-between">
                    <span>{t('order:refund_ship_fee')}</span>
                    <span>3,000원</span>
                </div>
            </div>
            <hr className="my-2 border-dashed" />
            <div className="flex justify-between font-semibold text-black">
                ...
                <span className="text-lg">33,539원</span>
            </div>
            <div className="text-xs text-gray-400 ml-2">└ {t('payment:credit_card')} (현대카드)</div>
            <div className="flex justify-between">
