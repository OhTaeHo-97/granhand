        ...
        <div className="bg-white rounded-md text-sm text-gray-600 space-y-2 w-full">
            ...
            <div className="border rounded-md p-6 space-y-3 shadow-md">
                <div className="flex justify-between">
                    <span className="text-gray-400">{t('payment:amount')}</span>
                    <span>55,000원</span>
                </div>
                <div className="flex justify-between">
                    <span className="text-gray-400">{t('payment:ship_fee')}</span>
                    <span>0원</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                    <span className="text-gray-400">{t('payment:used_points')}</span>
                    <span className="text-black">-5,000원</span>
                </div>
                <hr className="my-2 border-dashed" />
                <div className="flex justify-between font-semibold text-black">
                    <span className="text-gray-400">{t('payment:total_amount')}</span>
                    <span>45,000원</span>
                </div>
