...
export default function TwoButtonModal({ open, setOpen, contents, btnText1, btnText2, locale, nextLink }: { open: boolean, setOpen: (value: boolean) => void, contents: string, btnText1: string, btnText2: string, locale: LocaleTypes, nextLink?: string }) {
