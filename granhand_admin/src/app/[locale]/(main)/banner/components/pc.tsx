...
export default function PcBanner() {
    ...
    const [banners, setBanners] = useState<Banner[]>(
        Array.from({ length: 10 }, (_, i) => createInitialBanner(i + 1))
    )
            ...
            <div className="overflow-x-auto mt-10">
                ...
                <tbody>
                        ...
                        <td key="event_fix2" className="border border-[#5E5955] py-3 px-3 align-middle text-center">
                            <div className="flex justify-between gap-1">
                                ...
                                <div className="flex gap-1">
                                    ...
                                    <Button variant="outline" className="flex items-center gap-1 px-2 py-1 text-xs hover:bg-gray-100" onClick={() => handleBannerDelete(7)}>{t('delete')}</Button>
                                </div>
                            </div>
                        </td>
                        <th className="border border-[#DBD7D0] bg-[#322A2408] text-[#6F6963] font-medium py-3 px-3 text-center align-middle">3</th>
                        <td key="event_fix3" className="border border-[#5E5955] py-3 px-3 align-middle text-center">
                            <div className="flex justify-between gap-1">
                                ...
                                <div className="flex gap-1">
                                    ...
                                    <Button variant="outline" className="flex items-center gap-1 px-2 py-1 text-xs hover:bg-gray-100" onClick={() => handleBannerDelete(8)}>{t('delete')}</Button>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td key="event_preview3" className="border border-gray-200 py-4 px-3 align-top text-center">
                            <div className="w-28 h-36 flex items-center justify-center bg-gray-200 rounded mx-auto">
                                {banners[8].image.image && banners[8].image.image.file.type && banners[8].image.image.file.type.startsWith('image/') && (
                                    <Image
                                        src={banners[8].image.image.previewUrl}
                                        alt={`Preview of ${banners[8].image.image.file.name}`}
                                        width={400}
                                        height={400}
                                        style={{ maxWidth: '100px', maxHeight: '100px', marginRight: '10px', objectFit: 'cover' }}
                                    />
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td key="popup_preview1" className="border border-[#5E5955] py-4 px-3 align-top text-center">
                            <div className="w-28 h-36 flex items-center justify-center bg-gray-200 rounded mx-auto">
                                {banners[9].image.image && banners[9].image.image.file.type && banners[9].image.image.file.type.startsWith('image/') && (
                                    <Image
                                        src={banners[9].image.image.previewUrl}
                                        alt={`Preview of ${banners[9].image.image.file.name}`}
                                        width={400}
                                        height={400}
                                        style={{ maxWidth: '100px', maxHeight: '100px', marginRight: '10px', objectFit: 'cover' }}
                                    />
