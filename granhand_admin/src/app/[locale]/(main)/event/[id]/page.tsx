...
import CreateEventHeader from "../register/components/header";
import EventContents from "../register/components/event-contents";
        ...
        <main className="flex-1 border">
            <div className="flex justify-between p-12">
                ...
                <div className="space-x-2">
                    ...
                    <Button className="bg-[#322A24] text-white w-25" onClick={handleEdit}>
                        {/* {t('event:publish')} */}
                        수정 완료
                    </Button>
                </div>
