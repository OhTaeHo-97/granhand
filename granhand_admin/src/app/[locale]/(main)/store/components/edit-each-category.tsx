...
export default function EditEachCategory({ images, handleFileChange, handleDelete, handleSave, setOpen, t }: { images: File[], handleFileChange: (value: React.ChangeEvent<HTMLInputElement>) => void, handleDelete: (value: number) => void, handleSave: () => void, setOpen: (value: boolean) => void, t: (key: string) => string }) {
