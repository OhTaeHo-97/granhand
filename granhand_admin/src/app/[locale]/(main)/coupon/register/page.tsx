...
export default function RegisterCouponPage() {
    const [startDate, setStartDate] = useState<Date | undefined>(new Date('2024-01-04'))
    const [endDate, setEndDate] = useState<Date | undefined>(new Date('2024-10-04'))
    ...
    return (
        <div className="flex-1 border">
            <div className="p-12 text-black text-sm space-y-4">
                <h1 className="text-2xl font-bold text-[#5E5955]">쿠폰 발급</h1>
            </div>
            <div className="mx-auto px-6 py-8 space-y-12">
                <div className="shadow-md p-8">
                    <CouponInfo t={t} />
                    <UsageInfo startDate={startDate} endDate={endDate} startTime={startTime} endTime={endTime} setStartDate={setStartDate} setEndDate={setEndDate} setStartTime={setStartTime} setEndTime={setEndTime} t={t} />
                </div>
            </div>
        </div>
    )
