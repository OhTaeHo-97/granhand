...
export default function ProductListPage() {
    ...
    const fetchProductList = async (params: Record<string, string | number | boolean | undefined | null>) => {
    ...
    return (
        <div className="flex-1 border">
            <div className="p-12 text-[#1A1A1A] text-sm space-y-4">
                <div className="flex justify-between items-center">
                    <div className="text-[#5E5955] text-sm">
                ...
                <ProductListHeader selectedCategories={selectedCategories} currentPage={currentPage} itemCnt={itemCnt} setSelectedCategories={setSelectedCategories} fetchProductList={fetchProductList} />
                <ProductList currentPage={currentPage} itemCnt={itemCnt} totalPage={totalPage} contents={contents} setCurrentPage={setCurrentPage} setItemCnt={setItemCnt} fetchProductList={fetchProductList} />
            </div>
        </div>
    )
}