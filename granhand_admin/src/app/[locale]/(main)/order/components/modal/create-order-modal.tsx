...
export default function CreateOrderModal({ open, setOpen }: { open: boolean, setOpen: (value: boolean) => void }) {
    return (
        <Dialog open={open} onOpenChange={setOpen} >
            <DialogContent className="bg-white max-w-280 min-h-80 max-h-screen w-full overflow-auto mx-auto">
            <DialogHeader>
                <DialogTitle><span className="font-bold text-2xl text-[#111111]">주문 생성</span></DialogTitle>
            </DialogHeader>
                        ...
                        <div className="text-[#111111]">
                            <div className="space-y-2 mt-8">
                                ...
                                <div className="grid grid-cols-[100px_1fr] h-full">
                                    ...
                                    <div className="px-5 py-2 w-full">
                                        <div className="flex items-center gap-4">
                                            <Input placeholder="주소 입력" defaultValue="서울시 종로구 8" />
                                        </div>
                                    </div>
                                </div>
                                <div className="grid grid-cols-[100px_1fr] h-full">
            ...
            <DialogFooter className="!flex !items-center">
                ...
                <Button className="w-1/6 text-[#2854f3] hover:bg-[#322A2408]" onClick={() => setOpen(false)}>주문 생성</Button>
            </DialogFooter>
            </DialogContent>
        </Dialog>
    )
