...
export default function DenyReturnModalContents({ t }: { t: (key: string) => string }) {
    return (
        <>
            <div className="p-4">
                <ul className="list-disc text-[#6F6963]">
                    <li>{t('order:process_return_reject_info1')}</li>
                    <li>{t('order:process_return_reject_info2')}</li>
                </ul>
            </div>
                ...
                <div className="rounded-md mt-6 space-y-3">
                    <div className="grid grid-cols-[110px_1fr] h-full m-0">
                        <div className="flex justify-start p-2">
                            <Label className="font-bold">{t('order:reason_return_reject')}*</Label>
                        </div>
